...
<body>
    ...
    <div class="d-flex align-items-center justify-content-center ht-100v">
        <video id="headVideo" class="pos-absolute a-0 wd-100p ht-100p object-fit-cover" autoplay muted loop>
            <source src="{{ asset('admin/videos/video1.mp4') }}" type="video/mp4">
            <source src="{{ asset('admin/videos/video1.ogv') }}" type="video/ogg">
            <source src="{{ asset('admin/videos/video1.webm') }}" type="video/webm">
        </video><!-- /video -->
        <div class="overlay-body bg-black-7 d-flex align-items-center justify-content-center">
            <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 rounded bg-black-6">
                <div class="signin-logo tx-center tx-28 tx-bold tx-white">
                    <span class="tx-normal">[</span> Online  <span class="tx-info">CV</span> <span class="tx-normal">]</span>
                </div>
                <div class="tx-white-5 tx-center mg-b-60">Online Cv Management </div>
                <form method="POST" action="{{ route('login') }}">
                    @csrf
                    <div class="form-group">
                        <input type="email" class="form-control fc-outline-dark" name="email" placeholder="Enter your email"
    ...
    <script src="{{ asset('adminlib/jquery/jquery.min.js') }}/"></script>
